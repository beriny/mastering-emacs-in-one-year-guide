...
第一,典型Vim的用户的问题是没有充份利用Leader快捷键.我看过大多数Vim高手在GitHub上的设置,他们一般定义10到20个左右*Leader相关的快捷键.

我定义了300个Leader相关的快捷键.而且我的插件比典型Evil用户(如spacemacs)少很多,才200个插件,所以我要用的快捷键也少.

一般用户大概有5000到10000个Leader相关快捷键可用.
...
当我们运行Shell的时候,命令和代码往往是从别的地方拷贝过来的.
