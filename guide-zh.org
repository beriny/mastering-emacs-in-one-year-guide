...
很好避免门户之见的关键就是意识到标签只存在于你的主观想像中.真实的世界是不会因为你的想像而扭曲.

以Emacs和Vim的快捷键为例,事实上两种快捷键完全可以无缝接合.

关于门户之见的反例绝不仅仅局限于快捷键.比如关于[[https://www.emacswiki.org/emacs/InteractivelyDoThings][ido-mode]]和[[https://github.com/emacs-helm/helm][helm-mode]]的争论,很多人就一定要两者取一.限于篇幅不多谈了.
*** 以科学理性做指导
之前有读者反映我的方法类似于大学里写论文做研究,事实上这正是我的灵感来源.

学习Emacs和我们学习成为工程师科学家本质上是一回事:
第一步,我们要读教科书掌握基本知识.
第二步,然后会在教授指导下读一些本专业的经典论文.
第三步,在对本行业有了初步了解后(谁在研究什么),我们会决定一个方向做深入的研究.
